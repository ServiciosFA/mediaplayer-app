...
const currentTrackSlice = createSlice({
  ...
  reducers: {
    SET_CURRENT_TRACK(state, action) {
      ...
      state.imgUrl = action.payload?.album.images[1].url;
      state.releaseDate = action.payload?.album.release_date;
      state.artist = action.payload?.album.artists[0].name;
    ...
    NEXT_TRACK(state, action) {
      ...
      state.id = data.id;
      state.imgUrl = data.album.images[1].url;
      state.releaseDate = data.album.release_date;
      state.artist = data.album.artists[0].name;
